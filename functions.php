...
function pomerol_home_enqueue_scripts()
{
  ...
  if (is_page('home')) {
    wp_register_style('pom_home_css', get_stylesheet_directory_uri() . '/assets/css/home.min.css?' . time(), array(), '1');
    wp_enqueue_style('pom_home_css');
    wp_register_style('pom_carousel', get_stylesheet_directory_uri() . '/assets/css/owl.carousel.min.css?' . time(), array(), '1');
    wp_enqueue_style('pom_carousel');
    wp_enqueue_style( 'my-theme-style', 'https://cdn.rawgit.com/michalsnik/aos/2.0.4/dist/aos.css?' . time(), array(), '1.0.0' );
    
  }else if (is_page('about-us') ) {

    wp_register_style('pom_css', get_stylesheet_directory_uri() . '/assets/css/home.min.css?' . time(), array(), '1');
    wp_enqueue_style('pom_ css');
    wp_register_style('about-us-style', get_stylesheet_directory_uri() . '/assets/css/owl.carousel.min.css?' . time(), array(), '1');
    wp_enqueue_style('about-us-style');    
    wp_register_style('about-inner_min', get_stylesheet_directory_uri() . '/assets/css/about.min.css?' . time(), array(), '1');
    wp_enqueue_style('about-inner_min');
    wp_enqueue_style( 'theme-style', 'https://cdn.rawgit.com/michalsnik/aos/2.0.4/dist/aos.css?' . time(), array(), '1.0.0' );
    
  }else if (is_page('services') ) {

    wp_register_style('pom_css', get_stylesheet_directory_uri() . '/assets/css/home.min.css?' . time(), array(), '1');
    wp_enqueue_style('pom_ css');
    wp_register_style('service-style', get_stylesheet_directory_uri() . '/assets/css/owl.carousel.min.css?' . time(), array(), '1');
    wp_enqueue_style('service-style');    
    wp_register_style('service-inner_min', get_stylesheet_directory_uri() . '/assets/css/service.min.css?' . time(), array(), '1');
    ...
    wp_register_style('pom_css', get_stylesheet_directory_uri() . '/assets/css/home.min.css?' . time(), array(), '1');
    wp_enqueue_style('pom_ css');
    wp_register_style('contact-us-style', get_stylesheet_directory_uri() . '/assets/css/owl.carousel.min.css?' . time(), array(), '1');
    wp_enqueue_style('contact-us-style');    
    wp_register_style('contact-us-inner_min', get_stylesheet_directory_uri() . '/assets/css/contactus.min.css?' . time(), array(), '1');
    ...
    wp_register_style('pom_css', get_stylesheet_directory_uri() . '/assets/css/home.min.css?' . time(), array(), '1');
    wp_enqueue_style('pom_ css');
    wp_register_style('single-service-style', get_stylesheet_directory_uri() . '/assets/css/owl.carousel.min.css?' . time(), array(), '1');
    wp_enqueue_style('single-service-style');    
    wp_register_style('single-service-inner_min', get_stylesheet_directory_uri() . '/assets/css/service.min.css?' . time(), array(), '1');
    wp_enqueue_style('single-service-inner_min');
    wp_enqueue_style( 'single-service-style', 'https://cdn.rawgit.com/michalsnik/aos/2.0.4/dist/aos.css?' . time(), array(), '1.0.0' );
    
  } else {
    wp_register_style('home_common', get_stylesheet_directory_uri() . '/assets/css/home.min.css?' . time(), array(), '1');

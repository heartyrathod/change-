...
<section class="cc-banner">
        <div class="cc-banner-bg ">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/media/banner-bg1.webp" class="img-fluid" width="1920" height="1080" alt="banner-bg" title="banner-bg">
        </div>
          ...
          <?php              
            ...
            <a href="<?php echo get_permalink($service->ID); ?>" class="cc-services-details" data-aos="flip-right" data-aos-duration="1500">              
                ...
                <div class="cc-services-details-img">
                  <img src="<?php  echo $image[0]; ?>" class="img-fluid" width="80" height="80" alt="<?php echo $service->post_title; ?>" title="<?php echo $service->post_title; ?>">
                </div>
         ...
         <?php
            ...
            <div class="item">    
              ...
              <div class="cc-testimonials-details">
                ...
                <p class="cc-testimonials-details-text">
                  <?php echo $testimonials->post_content; ?></p>
                <div class="cc-testimonials-client">
                  ...
                  <p class="cc-testimonials-client-details-designation">
                    <?php echo $testimonials->post_excerpt; ?></p>
                  </div>
                </div>
              </div>
            </div>
